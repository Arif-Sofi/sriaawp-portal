...
- NEXT: PR7 `feat/admin-users` (admin user/role management: assign/revoke roles, approve parent verification, manual + CSV family linking, departments), branched off `feat/parent-dashboard`.
