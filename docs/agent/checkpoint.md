...
- NEXT: PR6 `feat/parent-dashboard` (parent dashboard with linked children from family_link, scoped to own links + audited student-data reads), branched off `feat/events-conflict`.
