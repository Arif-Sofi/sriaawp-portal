...
| #99 | `feat/engagement-tables` | `feat/ai-mode-3` | #82 | 0009 | In progress. news_reaction/news_comment(one-level trigger)/notification + app_setting(allow_student_comments=false) + 6 perm codes (student none) + inherited-visibility RLS. |
